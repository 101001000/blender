 ...
 * CPU and oneAPI. */
#if defined(__KERNEL_GPU__) && !defined(__KERNEL_ONEAPI__) && !(defined(__KERNEL_SIMPLE__) && (defined(CPU_KERNEL) || defined(SYCL_KERNEL) || defined(EMBREE_CPU_KERNEL) || defined(EMBREE_SYCL_KERNEL) || defined(DUMMY_KERNEL)))
