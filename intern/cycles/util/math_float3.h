...
#  if !(defined(__KERNEL_METAL__) || defined(__KERNEL_CUDA__) || defined(__KERNEL_HIP__) || \
        defined(__KERNEL_ONEAPI__) || defined(EMBREE_SYCL_KERNEL) || (defined(__KERNEL_SIMPLE__) && defined(OPTIX_KERNEL)) || (defined(__KERNEL_SIMPLE__) && defined(HIP_KERNEL)) || (defined(__KERNEL_SIMPLE__) && defined(CUDA_KERNEL)))
