...
#  if !defined(__KERNEL_CUDA__) && !defined(__KERNEL_HIP__) && !defined(__KERNEL_ONEAPI__) && !(defined(__KERNEL_SIMPLE__) && (defined(PRT_KERNEL_CUDA) || defined(PRT_KERNEL_HIP) || defined(PRT_KERNEL_EMBREE_SYCL) || defined(PRT_KERNEL_SYCL)))
...
#elif defined(__KERNEL_CUDA__) || defined(__KERNEL_HIP__) || defined(PRT_KERNEL_HIP)
...
ccl_device_inline float half_to_float_image(half h)
{
  ...
  return float(h);
#elif defined(__KERNEL_CUDA__) || defined(__KERNEL_HIP__) || (defined(PRT_KERNEL_HIP) && defined(__KERNEL_SIMPLE__)) || (defined(PRT_KERNEL_CUDA) && defined(__KERNEL_SIMPLE__))
