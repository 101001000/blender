...
#  if !defined(__KERNEL_CUDA__) && !defined(__KERNEL_HIP__) && !defined(__KERNEL_ONEAPI__) && !(defined(__KERNEL_SIMPLE__) && (defined(OPTIX_KERNEL) || defined(CUDA_KERNEL) || defined(HIP_KERNEL) || defined(EMBREE_SYCL_KERNEL)))
